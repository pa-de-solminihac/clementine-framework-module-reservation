...
if (!isset($request->GET['start_date'])) {
    ...
    $info_resa = $reservation_mdl->getAllInfoReservationById($request->GET['clementine_reservation-id']);
...
<form method="post" class="clementine_crud-update_form clementine_crud-form">
	...
	<a href="<?php
echo __WWW__ . '/reservation/update?clementine_reservation-id=' . $request->GET['clementine_reservation-id'] . '&start_date=' . $start_date . '&clementine_reservation_ressource-id=' . $request->GET['clementine_reservation_ressource-id']; ?>"
