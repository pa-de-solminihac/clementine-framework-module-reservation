...
<a class="clementine_crud-update-blocked clementine_crud-blockedbutton <?php
    ...
    href="<?php
    echo __WWW__ . '/reservation/block?start_date=' . $request->GET['start_date'] . '&clementine_reservation_ressource-id=' . $request->GET['clementine_reservation_ressource-id'] . '&is_iframe=1'; ?>"
